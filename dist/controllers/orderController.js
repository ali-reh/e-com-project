...
export const getAllOrders = async (req, res, next) => {
    try {
        ...
        const orders = await Order.getAll(parseInt(limit), parseInt(offset), filters);
...
export const checkout = async (req, res, next) => {
    try {
        const { customer_email, customer_name, customer_phone, shipping_address, billing_address, shipping_details, billing_details, subtotal, shipping_cost, tax, total, items, payment_method } = req.body;
